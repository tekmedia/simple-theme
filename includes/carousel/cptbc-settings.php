...
class cptbc_settings_page {
	...
	public function add_plugin_page() {
		add_submenu_page('edit.php?post_type=cptbc', 'Свойства', 'Свойства', 'manage_options', 'cpt-bootstrap-carousel', array($this,'create_admin_page'));
	}
	...
	public function create_admin_page() {
        ...
        <div id="tm_carousel_shortcodes" class="postbox">
            <div class="inside">
                <h2>Шорткоды</h2>
                <ul>
                    <li> 
                        <p><code>interval</code> <em>(default 5000)</em></p>
                        <ul>
                            <li>
                                Length of time for the caption to pause on each image. Time in milliseconds.<br/>
                                [image-carousel interval=”12000″]
                            </li>
                        </ul>
                    </li>
                    <li> 
                        <p><code>showcaption</code> <em>(default true)</em></p>
                        <ul>
                            <li>
                                Whether to display the text caption on each image or not. <code>true</code> or <code>false</code>.<br/>
                                [image-carousel showcaption=”false”]
                            </li>
                        </ul>
                    </li>
                    <li> 
                        <p><code>showcontrols</code> <em>(default true)</em></p>
                        <ul>
                            <li>
                                Whether to display the control arrows or not. <code>true</code> or <code>false</code>.<br/>
                                [image-carousel showcontrols=”false”]
                            </li>
                        </ul>
                    </li>
                    <li> 
                        <p><code>orderby</code> and <code>order</code> <em>(default <code>menu_order</code> <code>ASC</code>)</em></p>
                        <ul>
                            <li>
                                What order to display the posts in. Uses <a href="https://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters">WP_Query terms</a>.<br/>
                                [image-carousel orderby=”rand”]<br/>
                                [image-carousel orderby=”date” orderby=”DESC”]
                            </li>
                        </ul>
                    </li>
                    <li> 
                        <p><code>category</code> <em>(default all)</em></p>
                        <ul>
                            <li>
                                Filter carousel items by a comma separated list of carousel category slugs.<br/>
                                [image-carousel category=”homepage,highlights”]
                            </li>
                        </ul>
                    </li>
                    <li> 
                        <p><code>id</code> <em>(default all)</em></p>
                        <ul>
                            <li>Specify the ID of a specific carousel post to display only one image.</li>
                            <li>
                                Find the image ID by looking at the edit post link, eg. post 109 would be <code>/wp-admin/post.php?post=109&amp;action=edit</code><br/>
                                [image-carousel id=”109″]
                            </li>
                        </ul>
                    </li>
                    <li> 
                        <p><code>twbs</code> <em>(default 2)</em></p>
                        <ul>
                            <li>
                                Output markup for Twitter Bootstrap Version 2 or 3.<br/>
	...
	public function page_init() {		
		...
		add_settings_field(
				'showcaption', // ID
				'Показывать заголовок/описание?', // Title 
		...
		add_settings_field(
				'showcontrols', // ID
				'Показать элементы навигации?', // Title 
		...
		add_settings_field(
				...
				'Использовать фоновое изображение?', // Title 
		...
		add_settings_field(
                ...
                'Высота контейнера фонового изображения (px)', // Title
		...
		add_settings_field(
				...
				'Свойство фонового изображения', // Title
		...
		add_settings_field(
				...
				'Использовать Javascript для анимирования слайдшоу?', // Title 
		...
		add_settings_field(
				'link_button', // ID
				'Показывать ссылки в подписи как кнопки', // Title
		...
		add_settings_field(
				'link_button_text', // ID
				'Текст ссылки по умолчанию', // Title
		...
		add_settings_field(
				...
				__('HTML до ссылки', 'cpt-bootstrap-carousel'), // Title
		...
		add_settings_field(
				...
				__('HTML после ссылки', 'cpt-bootstrap-carousel'), // Title
