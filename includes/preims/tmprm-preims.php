...
////////////////////////////
add_action( 'init', 'tmprm_post_type' );
function tmprm_post_type() {
	$labels = array(
	...
	register_post_type('tmprm', $args);
}

// Load in the pages doing everything else!
require_once('tmprm-admin.php');
require_once('tmprm-settings.php');
require_once('tmprm-frontend.php');
